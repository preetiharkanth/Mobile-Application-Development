...
public class NoteDAO {
    ...
    public Note get(long id){
        ...
        Cursor c = db.query(true, NoteTable.TABLENAME, new String[]{NoteTable.COLUMN_ID, NoteTable.COLUMN_SUBJECT, NoteTable.COLUMN_TEXT},
    ...
    public List<Note> getAll(){
        ...
        Cursor c = db.query(NoteTable.TABLENAME, new String[]{
                NoteTable.COLUMN_ID, NoteTable.COLUMN_SUBJECT,
                NoteTable.COLUMN_TEXT}, null, null, null, null, null);
        if(c != null && c.moveToFirst()) {
